                ...
                <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                   ...
                   <div className="divide-y divide-gray-100">
                        {pendingTasks.length === 0 ? (
                           <div className="p-8 text-center"> <CheckCircle className="mx-auto h-8 w-8 text-green-100 mb-2" /> <h3 className="text-sm font-medium text-gray-900">暂无待办事项</h3> </div>
                        ) : (
                           pendingTasks.map(task => (
                              <div key={task.id} className="p-6 flex items-center justify-between hover:bg-gray-50 transition-colors">
                                 ...
                                 <div className="flex gap-3">
                                    <button onClick={() => handleReject(task)} className="px-4 py-2 border border-gray-200 text-gray-600 text-sm font-medium rounded-lg hover:bg-red-50 hover:text-red-600 hover:border-red-100 transition-colors"> 驳回 </button>
                                    <button onClick={() => handleApprove(task)} className="px-4 py-2 bg-blue-600 text-white text-sm font-medium rounded-lg hover:bg-blue-700 shadow-sm transition-colors"> 通过审核 </button>
                                 </div>
                              </div>
                           ))
                        )}
